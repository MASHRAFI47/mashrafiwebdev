...
//react icons
import { FaFacebook, FaInstagram, FaEnvelope, FaLinkedin } from "react-icons/fa6";
                ...
                <Row>
                    ...
                    <Col sm={6}>
                        <div className={style.icons}>
                            ...
                            <a href="https://www.linkedin.com/in/mashrafi47/" target='_blank'><FaLinkedin className={style.icon}/></a>
